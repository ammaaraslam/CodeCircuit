...
![Visual Studio IntelliCode Demo](intellicode-demo.gif)
<center><p>Visual Studio IntelliCode Demo</p></center>
...
![Path IntelliSense Demo](path-intellisense-demo.gif)
<center><p>Path IntelliSense Demo</p></center>
...
![Markdown All in One Demo](markdown-all-in-one-demo.gif)
<center><p>Markdown All in One Demo</p></center>
...
![Prettier CSS Demo](prettier-demo-css.gif)
<center><p>Prettier CSS Demo</p></center>

![Prettier React Demo](prettier-demo-react.gif)
<center><p>Prettier React Demo</p></center>
...
![Auto Rename Tag Extension Demo](auto-rename-tag-extension-demo.gif)
<center><p>Auto Rename Tags Extension Demo</p></center>
...
![Colorize CSS Demo](colorize-demo-css.gif)
<center><p>Colorize CSS Demo</p></center>

![Colorize Styled Components Demo](colorize-demo-css-in-js.gif)
<center><p>Colorize CSS-in-JavaScript (Styled-Components) Demo</p></center>

> **Note:-**If you want to add **colorize** to other languages, you just have to include it in your settings.json file. For example:
> ![Colorize Add Language Example](colorize-settings.png)
...
![Polacode Demo](polacode-demo.gif)
<center><p>Polacode Demo</p></center>
